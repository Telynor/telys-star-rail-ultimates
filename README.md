...
`https://raw.githubusercontent.com/Telynor/telys-star-rail-ultimates/main/module.json`

The GitHub repository must be named `telys-star-rail-ultimates` under the `Telynor` account for that URL to work.
